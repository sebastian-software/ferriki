...
assert(rootReadme.startsWith("<!-- This file is generated by mdtheme."), "root README must be generated by mdtheme");
assert(!rootReadme.includes("<!-- ferramenta-family:"), "root README must not retain legacy family markers");
