...
import { bundledLanguages, bundledLanguagesAlias, bundledLanguagesBase, bundledLanguagesInfo, bundledThemes, bundledThemesInfo } from './standard-catalog.mjs';
    ...
    get(target, prop, receiver) {
      ...
      if (prop === "codeToHtml" && typeof value === "function") {
        return (code, options) => {
          ...
          if (hasDecorations || hasTransformers || opts?.lang === "astro" || opts?.lang === "vue")
      ...
      if (prop === "codeToHast" && typeof value === "function") {
        return (code, options) => {
          ...
          if (hasDecorations || hasTransformers || hasColorReplacements || opts?.lang === "astro" || opts?.lang === "vue" || opts?.mergeWhitespaces === "never" || opts?.mergeSameStyleTokens)
            return value.call(target, code, options);
          try {
            ensureNativeStandardAssets(native, target, options);
