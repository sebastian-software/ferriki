...
fn resolve_color_for_scope_stack_owned(
    scope_stack: &[String],
    theme: &ThemeData,
...
fn resolve_color_with_extra_scope(
    scope_stack: &[String],
    extra: &str,
    theme: &ThemeData,
    cache: &mut ThemeCache,
...
fn resolve_json_scope_color_with_fallback(
    scope_names: &[&str],
...
fn apply_color_replacements_to_lines(
...
fn apply_color_replacements_to_json_theme_profile(
...
fn apply_color_replacements_to_html_theme_profile(
...
fn normalize_vue_tag_end_tokens(
    lines: &mut [Vec<StyledJsonToken>],
    root_scope: Option<&str>,
    theme: &ThemeData,
) {
...
fn retokenize_astro_default_token(
...
fn recolor_astro_contextual_tokens(
...
fn merge_astro_punctuation_sequences(
    line: &[StyledJsonToken],
    theme: &ThemeData,
) -> Vec<StyledJsonToken> {
    let punctuation = resolve_token_style(
